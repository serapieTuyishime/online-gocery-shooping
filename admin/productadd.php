          ...
          if (isset($_GET['required'])) {
            ...
            elseif ($_GET["required"]=="image") {
               echo '<p class="error-msg text-danger">Incorrect image format</p>';
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="Product Name" name="product" autofocus="autofocus"  onkeypress= "return alphabets(event)" maxlength="40">
                            </div>
                            <div class="form-group">
                              <input type="number" class="form-control" placeholder="Quantity" name="quantity" >
                            </div>
                            <div class="form-group">
                              <input class="form-control" type="text" id="price" placeholder="Price" name="price"  onkeypress= "return floats(event)">
                            </div>
                            <div class="form-group">
                              <input class="form-control" type="text" id="price" placeholder="Profit" name="markup"  onkeypress= "return floats(event)">
                            </div>
                            <div class="form-group">
                              <input class="form-control" type="hidden" name="user" value="<?php echo $_SESSION['userid']; ?>">
                            </div>
                            <div class="form-group">
                              <input class="form-control" readonly type="date" placeholder="Date In" name="date" value="<?php echo $date ?>">
                            </div>
                            <div class="form-group">
